...
const ModernPortfolio = () => {
  ...
  return (
    <div className='bg-black text-white'>
        ...
        <div className='max-w-7xl mx-auto px-6 py-4'>
          <div className='flex justify-center items-center'>
            <div className='flex space-x-12'>
              {['Home', 'Skills', 'Open Source', 'Conferences', 'Workshops', 'Blogs'].map((item) => (
                <button
                  key={item}
      ...
      >
        {/* Dark Navy Background - Same as Reference */}
    ...
    expect(welcomeText).toBe('Welcome!');
        ...
        <div className='fixed right-8 top-1/2 transform -translate-y-1/2 z-50 flex flex-col space-y-4'>
          <a
            ...
            className='w-12 h-12 bg-yellow-400 hover:bg-yellow-300 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 shadow-lg'
          >
