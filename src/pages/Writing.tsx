        ...
        <Wrap>
          ...
          >
            ...
            <div>
              ...
              <h3 style={{ fontSize: mobile ? 24 : 38, margin: '12px 0 16px', letterSpacing: -1, fontWeight: 500, lineHeight: 1.05 }}>
                Appium Insights. Strategies for Successful Mobile Automation.
              </h3>
              <p style={{ fontSize: mobile ? 15 : 17, lineHeight: 1.6, color: T.subdued, margin: 0, maxWidth: 560 }}>
          ...
          <div style={{ marginTop: mobile ? 48 : 72 }}>
            ...
            <div style={{ display: 'grid', gap: 0 }}>
              {essays.map((w, i) => (
                ...
                >
                  ...
                  <div>
                    <div style={{ fontSize: mobile ? 18 : 22, color: T.fg, letterSpacing: -0.3, lineHeight: 1.3 }}>{w.title}</div>
                    <div style={{ fontSize: mobile ? 14 : 15, color: T.subdued, marginTop: 6, lineHeight: 1.55 }}>{w.blurb}</div>
                  </div>
                  <span
                    style={{
                      fontFamily: T.mono,
